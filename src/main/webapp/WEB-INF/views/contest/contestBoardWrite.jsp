...
<body>
    ...
    <section id="container">
        ...
        <div>
	        ...
	        <form name="insertForm" action="<c:url value='/contest/contestBoardInsert'/>" method="POST" enctype="multipart/form-data">
				...
				<input type="hidden" name="BO_NUM" value="4">
					...
					<div style="display:inline-flex; width:100%; height:70px; padding-left:380px; ">
						...
						<button type="button" style="width:100px; height:30px; onclick="location.href='<c:url value='/contest/contestBoardList?page=${scri.page}&perPageNum=${scri.perPageNum}&searchType=${scri.searchType}&keyword=${scri.keyword}'/>'">뒤로가기</button>
