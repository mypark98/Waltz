   ...
   <header>
        ...
        <div id="boast_update_box">      
            <form name="updateForm" action='<c:url value='/contest/contestBoardUpdate'/>' method="POST" enctype="multipart/form-data">   
               ...
               <%--  <div id="fileIndex">
                ...
                <div id="buttonBox">
                    <button type="button" style="width:100px; height:30px; margin-right:30px; cursor:pointer;" class="update_btn">수정</button>
    ...
    <!-- <form name="updateForm" action='<c:url value='/contest/contestBoardUpdate'/>' method="POST" enctype="multipart/form-data">   
        ...
        <div style="display:inline-flex; padding-left:370px; width:1030px; height:50px;">
           <button type="button" class="update_btn" style="margin-right:20px; width:100px; height:30px; ">수정</button>
