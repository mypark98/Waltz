...
<head>
   ...
   <meta charset="UTF-8">
    ...
    <title>왈츠장터</title>
    <link rel="stylesheet" href="/resources/css/boastwrite.css">
...
<body>
   ...
   <header>
    ...
    <section id="container">
        ...
        <div>
           ...
           <form name="insertForm" action="<c:url value='/market/marketBoardInsert'/>" method="POST" enctype="multipart/form-data">
            ...
            <input type="hidden" name="BO_NUM" value="2">
               ...
               <div style="width:100%; height:40px; margin-left:20px;">
                  ...
                  <input type="number" name="MAR_PRICE" id="price" style="border: rgb(218, 206, 206) solid 1px;  width:500px; height:25px;" placeholder="가격을 입력하세요." required>
               </div>
               
               
               <div style="margin-left:20px;">
                  <label for="content"></label>
                  <textarea id="content" name="PO_CONTENT" style="width:980px; height:400px; resize:none; border: rgb(218, 206, 206) solid 1px;" required></textarea>
               </div>
               ...
               <div style="display:inline-flex; width:100%; height:70px; padding-left:380px; ">
                  ...
                  <button type="button" style="width:100px; height:30px; onclick="location.href='<c:url value='/market/marketBoardList?page=${scri.page}&perPageNum=${scri.perPageNum}&searchType=${scri.searchType}&keyword=${scri.keyword}'/>'">뒤로가기</button>
   ...
   <%-- <form name="insertForm"
      action="<c:url value='/market/marketBoardInsert'/>" method="POST"
      ...
      <div>
         <label for="author">작성자</label> <input type="text" id="author"
            name="MEM_ID" readonly value=<c:out value="${authInfo.id}"/>>
      </div>
      <div>
         <label for="price">가격</label>
         <input type="number" name="MAR_PRICE" id="price">
      </div>

      <div class="form-group" id="file-list">
         <a href="#this" class="fileAdd_btn">파일추가</a>
      ...
      <div>
         ...
         <textarea id="content" name="PO_CONTENT" rows="10"></textarea>
      </div>
      <button type="button" onclick="insert()">등록하기</button>

      <button type="button"
         onclick="location.href='<c:url value='/market/marketBoardList?page=${scri.page}&perPageNum=${scri.perPageNum}&searchType=${scri.searchType}&keyword=${scri.keyword}'/>'">뒤로가기</button>
   </form>
