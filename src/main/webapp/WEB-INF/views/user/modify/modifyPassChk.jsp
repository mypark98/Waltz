...
<head>
    ...
    <link rel="stylesheet" href="resources/css/changechkpw.css">
...
$(document).ready(function(){
	...
	$("#submitBtn").on("click",function(event){
		...
		$.ajax({
			...
			type : "POST",
			dataType : "json",
			data : $("#pwdChkForm").serializeArray(),
			async:false,
		...
		if(isCheck){
			var modifyChk = document.getElementById("pwdChkForm");
                    ...
                    <div id="change_box">
                        <div id="change_personal">
                            ...
                            <!-- <form action=""> 
                                ...
                                <input type="submit" value="회원탈퇴" id="change_btn">    
                            </form> -->

                            <form action="/modifyChk" method="POST" id="pwdChkForm" onSubmit="return false;">
                                <input type="hidden" id="MEM_ID" name="MEM_ID" value="${authInfo.id}" />
                            <div> 
                                <label for="MEM_PW" id="pwd_title">비밀번호를 입력하세요.</label> <br>
                                <input type="password" id="MEM_PW" name="MEM_PW" />
                            </div>
                            <br>
                            <button class="btn btn-success" type="button" id="submitBtn">입력</button>
